...
# [1]继续添加 1层线性层 和 1层非线性层，loss也基本没变，有时候反而更差
# [2]改变隐藏层的神经元数量，loss基本没变化
# [3]调整lr = 0.01 为 0.1后，loss下降明显
...
class SimpleClassifier(nn.Module):
    def __init__(self, input_dim, hidden_dim, output_dim): # 层的个数 和 验证集精度
        ...
        # 继续添加 1层线性层 和 1层非线性层，loss也基本没变，有时候反而更差
        # self.relu2 = nn.ReLU()
